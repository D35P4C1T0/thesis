\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\textwidth]{chapters/librerie-plot/data/confronto_benchmark.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\textwidth]{chapters/librerie-plot/data/correlazione_rendering_totale.png}
